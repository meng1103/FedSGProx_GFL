...
|__OGBN-arxiv($\beta=0.8$)__     | 0.560    |  0.560    |   0.581   
|__Reddit($\beta=0.8$)__   | 0.907    |  0.928    |   0.931  


|       | __FedAvg__  | __FedAvg(+constraint terms)__  | __FedSGProx()__
|--------------| :------: | :----------------: | :-------:
|__Cora($\alpha=0.5$)__   | 0.764    |  0.79    |   0.782   
|__Citeseer($\alpha=0.5$)__   | 0.700    |  0.71    |   0.722   
|__OGBN-arxiv($\alpha=0.5$)__     | 0.611    |  0.642    |   0.645   
|__Reddit($\alpha=0.5$)__   | 0.935    |  0.943    |   0.942  
