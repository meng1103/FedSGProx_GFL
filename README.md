...
|--------------| :------: | :----------------: | :----------------: | :-------:
|__Cora($\beta=0.8$)__   | 0.758    |  0.790    |  0.    |   0.792   
|__Citeseer($\beta=0.8$)__   | 0.706    |  0.710    |  0.    |   0.740   
...
|       | __FedAvg__  | __FedAvg(+constraint terms)__  | __FedAvg(+sampler)__  | __FedSGProx()__
|--------------| :------: | :----------------: | :----------------: | :-------:
|__Cora($\alpha=0.5$)__   | 0.764    |  0.790    |  0.    |   0.782   
|__Citeseer($\alpha=0.5$)__   | 0.700    |  0.710    |  0.    |   0.722   
